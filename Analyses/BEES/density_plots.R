...
population.vector <- c("Avalon","Humboldt","Davis","Stanislaus","Stebbins","Riverside","Placerita")
...
pdf(file = "demography__.pdf", height = 11.00, width = 8.5)
...
plot.mult.densities(list.prior = list.logrr,
                    ...
                    par.name = expression(log[10](italic(r))),
                    col.vect = color.vector,
                    pop.vect = population.vector,
                    y_lim = c(0,1.5),
                    cex_axis = 1.6, cex_lab = 1.8,
