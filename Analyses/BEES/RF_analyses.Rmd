---
title: "Tracking Selection in Feral Bees with ABC-RF"
...
list.SumStats4Training.averageGenLoad<- list(Ava=global_sumstats4training_avalon_averageGenLoad, 
                                             Hum=global_sumstats4training_humboldt_averageGenLoad,
                                             Dav=global_sumstats4training_davis_averageGenLoad, 
                                             Sta=global_sumstats4training_stanislaus_averageGenLoad,
                                             Ste=global_sumstats4training_stebbins_averageGenLoad, 
                                             Riv=global_sumstats4training_riverside_averageGenLoad,
...
## AVALON
logfstne2.ava <- log10(globalFSTNe(x=global_sumstats4training_avalon$GSS_WCst, tau=104)) # correct[check made on 30/JUN/22]
...
## HUMBOLDT
logfstne2.hum <- log10(globalFSTNe(x=global_sumstats4training_humboldt$GSS_WCst, tau=49)) # correct[check made on 30/JUN/22]
...
## DAVIS
logfstne2.dav <- log10(globalFSTNe(x=global_sumstats4training_davis$GSS_WCst, tau=47)) # correct[check made on 30/JUN/22]
...
## STANISLAUS
logfstne2.sta <- log10(globalFSTNe(x=global_sumstats4training_stanislaus$GSS_WCst, tau=38)) # correct[check made on 30/JUN/22]
...
## STEBBINS
logfstne2.ste <- log10(globalFSTNe(x=global_sumstats4training_stebbins$GSS_WCst, tau=18)) # correct[check made on 30/JUN/22]
...
## RIVERSIDE
logfstne2.riv <- log10(globalFSTNe(x=global_sumstats4training_riverside$GSS_WCst, tau=15)) # correct[check made on 30/JUN/22]
...
## PLACERITA
logfstne2.pla <- log10(globalFSTNe(x=global_sumstats4training_placerita$GSS_WCst, tau=15)) # correct[check made on 30/JUN/22]
...
## List of estimated FST-NE
list.table.fstNe2 <- list(Ava=estimated.fstNe2.ava,Hum=estimated.fstNe2.hum, 
                          Dav=estimated.fstNe2.dav, Sta=estimated.fstNe2.sta, 
                          Ste=estimated.fstNe2.ste,Riv=estimated.fstNe2.riv,
                          Pla=estimated.fstNe2.pla)

#save(list.table.fstNe2, 
#    file = paste0("~/My_repositories/Tracking-selection/results/pipeline_v6_bees/random_forests/list_table_fstNe2",".RData"))
...
## List with all global reftable used for training for most of the parameters (except genetic load, prop strong selection, and gamma mean latent var)
#load(file=paste0("~/My_repositories/Tracking-selection/results/pipeline_v6_bees/list_global_SumStats4Training",".RData"))
```
